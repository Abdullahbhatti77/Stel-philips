<template>
  ...
  <div class="lg:w-full  bg-red-400 bgImg">
    ...
    <div class="w-full h-[600px] flex justify-center items-center manOverlayBg ">
      <div class="w-[60%]">
        <div class="text-5xl text-white  w-[100%] leading-snug">
          <div>Your <span class="text-white font-bold">Home</span> </div>
        </div>
        <p class="text-white mt-4 tracking-wide leading-snug lg:w-[50%]">
  ...
  <div
    ...
    <div class="max-w-4xl mx-auto ">
      ...
      <p class="">Little into here, out of hours are Weekends, Bank Holidays and between 6pm - 7am daily</p>
      <p class="pb-4">If it’s not urgent, the quickest way to report an issue and get it fixed, is using <span
          class="text-primary">our online form </span> now</p>
      <div class="flex gap-10  xxs:gap-2">
        <img class="lg:max-w-sm" src="../assets/phone.png" alt />
        <div class="mt-8 text-third  font-semibold font lg:text-4xl  sm:text-2xl xxxs:text-md">
          <pre>020 00000 000</pre>
        </div>
      </div>

      <button type="button"
        class="bg-trisec py-4 px-8 text-sm  xxxs:px-5 mt-8 text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600">What
        is an emergencey</button>
    </div>
  </div>
</template>
