<template>
  <div class="lg:w-full min-h-[600px] bg-red-400 bgImg">
    <div class="w-full h-[600px] flex justify-center items-center">
      <div class="w-[60%]">
        <h1 class="text-5xl text-white  w-[100%] leading-snug">
          <div>Our Story</div>
        </h1>
        <p class="text-white mt-4 tracking-wide leading-snug font-semibold lg:w-[50%]">
  ...
  <div class="lg:w-full flex justify-center">
    <div class="w-[60%]">
      <div class="lg:pt-40">
        <div class="lg:max-w-5xl grid md:grid-cols-2 grid-cols-1 h-[540px] gap-12">
          <div class>
            <h1 class="lg:text-4xl   mt-12 text-trisec leading-[50px] font-semibold">
          ...
          <div class="flex justify-center">
            <img class="lg:max-w-sm" src="../assets/HeroSection.png" alt="heroSection" />
          </div>
        </div>
      </div>
    ...
    <div class="lg:w-[60%]">
      <div class="py-44">
        <div class="lg:flex">
          ...
          <div class="flex-auto">
            <h1 class="text-4xl mt-10 px-8 text-trisec text-ellipsis leading-[40px] font-semibold">
        ...
        <div class="lg:flex">
          ...
          <div class="flex-auto">
            <img class="lg:max-w-sm px-11 mt-9" src="../assets/ncardImage.png" alt />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-5xl mx-auto w-[60%] lg:py-11">
      <div class="grid md:grid-cols-3 gap-4 grid-cols-1 sm:grid-cols-2 mt-16">
        ...
        <div class>
          ...
          <p class="text-white  text-md">Short description goes here like so in this featured icon element lore ipsum.</p>
        </div>
        <div class>
          <img class="w-20" src="../assets/blockN.png" alt />
          <h1 class="py-4 text-white font-bold text-2xl">Value</h1>
          <p class="text-white  text-md">Short description goes here like so in this featured icon element lore ipsum
    ...
    <div class="max-w-5xl mx-auto w-[60%]   lg:mr-1.5  pb-20 flex justify-center">
      <div class="grid md:grid-cols-3 gap-8 grid-cols-1 sm:grid-cols-2 mt-10">
        ...
        <div class>
          ...
          <h1 class="py-4 text-white font-bold text-2xl">value</h1>
          <p class="text-white  text-md">Short description goes here like so in this featured icon element lore ipsum
            short description goes here like</p>
        </div>
        <div class>
          <img class="w-20" src="../assets/blockN.png" alt />
          <h1 class="py-4 text-white font-bold text-2xl">Value</h1>
  ...
  <div class="tiltGirlBg relative overflow-hidden lg:w-full min-h-[600px]">
    <div class="absolute top-0 w-full h-full flex items-center flex-wrap justify-center left-0 tiltBg">
      <div class="w-full flex justify-center">
        <div class="lg:w-[60%]">
